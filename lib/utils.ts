...
export const teamMembers = [
  ...
  },
  {
    ...
    bio: "Priya leads our field operations and ensures every donation reaches those who need it most. Her background in logistics makes her invaluable.",
    achievements: ["10+ years experience", "Led 200+ campaigns", "Operations expert"],
    social: {
      linkedin: "#",
      twitter: "#",
      email: "priya@dwaparyug.org",
    },
  },
  {
    id: 3,
    ...
    image: "/placeholder.svg?height=300&width=300&text=Dr.+Anita+Mehta",
    bio: "Dr. Mehta oversees our healthcare initiatives and mobile medical units, bringing quality healthcare to remote areas.",
    achievements: ["MBBS, MD", "5000+ patients treated", "Rural healthcare specialist"],
    social: {
      linkedin: "#",
      twitter: "#",
      email: "anita@dwaparyug.org",
    },
  },
  {
    id: 4,
    ...
    bio: "Vikram builds relationships with local communities and ensures our programs are culturally sensitive and effective.",
    achievements: ["Community leader", "Multilingual", "Cultural bridge-builder"],
    social: {
      linkedin: "#",
      twitter: "#",
      email: "vikram@dwaparyug.org",
    },
  },
]
...
export const testimonials = [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=80&width=80&text=Rajesh",
    quote:
      "My daughter now has access to quality education thanks to Dwaparyug. The scholarship program changed our family's future forever. We are eternally grateful.",
    rating: 5,
    location: "Bihar",
  },
  {
    ...
    quote:
      "The mobile medical units reach places where healthcare was just a dream. We've saved countless lives and brought hope to the most remote communities.",
    rating: 5,
    location: "Rajasthan",
  },
]
...
//     category: "Emergency Relief",
//     status: "Active",
//     raised: formatCurrency(285000),
//     goal: formatCurrency(500000),
//     progress: 57,
//   },
//   {
//     id: 2,
...
//     category: "Festival",
//     status: "Active",
//     raised: formatCurrency(125000),
//     goal: formatCurrency(300000),
//     progress: 42,
//   },
//   {
//     id: 3,
...
//     category: "Education",
//     status: "Completed",
//     raised: formatCurrency(920000),
//     goal: formatCurrency(1000000),
//     progress: 92,
//   },
// ]
